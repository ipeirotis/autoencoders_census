...
router.post('/send-verification', requireAuth, async (req: Request, res: Response) => {
  try {
    ...
    logger.error('Send verification failed', { error: error instanceof Error ? error.message : String(error) });
...
router.post('/request-reset', async (req: Request, res: Response) => {
  try {
    ...
    logger.error('Request reset failed', { error: error instanceof Error ? error.message : String(error) });
